					...
					<div className="mb-6 rounded-lg border border-slate-800 bg-slate-800/30 p-4">
						...
						<form onSubmit={handleCreate} className="space-y-4">
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
								<div>
									<label htmlFor="board-slug" className="mb-1 block text-sm text-slate-300">
										Slug *
									</label>
									<input
										id="board-slug"
								...
								<div>
									<label htmlFor="board-name" className="mb-1 block text-sm text-slate-300">
										이름 *
									</label>
									<input
										id="board-name"
								...
								<div>
									<label htmlFor="board-description" className="mb-1 block text-sm text-slate-300">
										설명
									</label>
									<input
							...
							<div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
								<div>
									<label htmlFor="board-max-attachments" className="mb-1 block text-sm text-slate-300">
										최대 첨부파일 수
									</label>
									<input
								...
								<div>
									<label htmlFor="board-posts-per-page" className="mb-1 block text-sm text-slate-300">
										페이지당 게시물 수
									</label>
									<input
