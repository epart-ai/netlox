			...
			<div className="rounded-lg border border-slate-800 bg-slate-900 p-6 shadow">
				...
				<form onSubmit={handleSubmit} className="space-y-5">
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						<div>
							<label htmlFor="edit-board" className="mb-2 block text-sm text-slate-300">보드</label>
							<select
								id="edit-board"
					...
					<div>
						<label htmlFor="edit-attachments" className="mb-2 block text-sm text-slate-300">
					...
					<div>
						<label htmlFor="edit-title" className="mb-2 block text-sm text-slate-300">제목</label>
						<input
							id="edit-title"
							value={form.title}
							onChange={(event) =>
					...
					<div>
						<label htmlFor="edit-content" className="mb-2 block text-sm text-slate-300">내용</label>
						<textarea
							id="edit-content"
							value={form.content}
							onChange={(event) =>
					...
					<div>
						<label htmlFor="edit-link" className="mb-2 block text-sm text-slate-300">
							링크 (선택사항)
						</label>
						<input
							id="edit-link"
