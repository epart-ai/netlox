	...
	const challengeCardData = [
		{
			...
			icon: "/images/solutions/icon_edge-computing_challenge1.svg",
		},
		{
			...
			icon: "/images/solutions/icon_edge-computing_challenge2.svg",
		},
		{
			title: "Diverse Hardware",
			description:
				"Must run on various architectures, including ARM (ARM64, ARMv7) and NVIDIA EGX platforms.",
			icon: "/images/solutions/icon_edge-computing_challenge3.svg",
		},
	];
