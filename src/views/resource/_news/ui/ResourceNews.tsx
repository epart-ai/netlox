...
export async function ResourceNews({ searchParams }: ResourceNewsProps) {
	const boardSlug = "news";
				...
				<>
					...
					{usePagination && (
						<div className="mt-8 flex items-center justify-center gap-2">
							{currentPage > 1 && (
								<Link
									href={`/resource/news?page=${currentPage - 1}`}
