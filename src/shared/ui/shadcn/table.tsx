...
>(({ className, ...props }, ref) => (
	<thead ref={ref} className={cn("title-14 lg:title-16", className)} {...props} />
));
...
const TableHead = React.forwardRef<HTMLTableCellElement, HeaderDivProps>(
	({ className, scope = "col", ...props }, ref) => (
		<th
			...
			scope={scope}
			className={cn(
				"px-1.5 py-3 text-left font-medium lg:px-3 lg:py-4.5",
...
type CellDivProps = React.TdHTMLAttributes<HTMLTableCellElement> & { width?: string };
